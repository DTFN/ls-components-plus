 ...
 * 下载文件
 */
export function downLoadFile(filename: string = '', api: string, params: any = {}, data: any = {}, method: string = 'post', exportName: boolean = true, type: string = 'download') {
  return new Promise((resolve, reject) => {
