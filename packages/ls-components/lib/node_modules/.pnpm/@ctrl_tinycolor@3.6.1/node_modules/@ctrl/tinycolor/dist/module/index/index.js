...
var a = (i, t) => f(i, "name", { value: t, configurable: !0 });
import { rgbToHsv as p, rgbToHsl as c, rgbToHex as g, rgbaToHex as b, numberInputToObject as d } from "../conversion/index.js";
import { names as y } from "../css-color-names/index.js";
import { inputToRGB as l } from "../format-input/index.js";
import { boundAlpha as H, clamp01 as u, bound01 as v } from "../util/index.js";
var m = (
  /** @class */
  function() {
    function i(t, r) {
    ...
    return a(i, "TinyColor"), i.prototype.isDark = function() {
      ...
      return this.a = H(t), this.roundA = Math.round(100 * this.a) / 100, this;
      ...
      var t = p(this.r, this.g, this.b), r = Math.round(t.h * 360), n = Math.round(t.s * 100), o = Math.round(t.v * 100);
      ...
      var t = c(this.r, this.g, this.b), r = Math.round(t.h * 360), n = Math.round(t.s * 100), o = Math.round(t.l * 100);
      ...
      return t === void 0 && (t = !1), g(this.r, this.g, this.b, t);
    }, i.prototype.toHexString = function(t) {
      return t === void 0 && (t = !1), "#" + this.toHex(t);
    }, i.prototype.toHex8 = function(t) {
      return t === void 0 && (t = !1), b(this.r, this.g, this.b, this.a, t);
      ...
      if (this.a < 1)
        return !1;
      for (var t = "#" + g(this.r, this.g, this.b, !1), r = 0, n = Object.entries(y); r < n.length; r++) {
      ...
      t === void 0 && (t = 10);
      var r = this.toHsl();
      return r.l += t / 100, r.l = u(r.l), new i(r);
      ...
      t === void 0 && (t = 10);
      var r = this.toHsl();
      return r.s -= t / 100, r.s = u(r.s), new i(r);
