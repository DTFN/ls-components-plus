 ...
 * @param list
 */
export function loadJs(list: Array<any> = []) {
  const pAll: any = []
    ...
    pAll.push(
      new Promise((resolve, reject) => {
        ...
        script.onerror = function () {
          script.remove()
          reject(new Error(`Failed to load JS: ${item.src}`))
        }
      }),
    )
  })
...
export function removeJs(list: Array<any> = []) {
  list.forEach((item: any) => {
 ...
 * @param list
 */
export function loadCss(list: Array<any> = []) {
  const pAll: any = []
  list.forEach((item: any) => {
    pAll.push(
      new Promise((resolve, reject) => {
        ...
        link.onerror = function () {
          link.remove()
          reject(new Error(`Failed to load CSS: ${item.src}`))
        }
      }),
    )
  })
...
export function removeCss(list: Array<any> = []) {
  list.forEach((item: any) => {
