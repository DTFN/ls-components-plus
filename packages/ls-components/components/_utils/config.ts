...
export function getComponentPrefix(options?: LSOptions) {
  return options?.componentPrefix ?? COMPONENT_PREFIX
}

export function setGlobalConfig(app: App, options?: LSOptions): void {
...
export function setVariable(key: string, val: string): void {
