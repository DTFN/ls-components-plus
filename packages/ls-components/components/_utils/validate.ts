...
export const numbers01 = /^(?!0+(\.0+)?$)\d+(\.\d)?$/ // 大于0的数字且最多支持一位小数
...
// 匹配由数字、字母和横杠（-）组成的字符串
export const string01 = /^[A-Z0-9\-]+$/i

export const string01_msg = '请输入数字、字母或横杠（-）的组合！'

// 匹配由数字、字母、下划线（_）和横杠（-）组成的字符串
export const string02 = /^[\w\-]+$/

export const string02_msg = '请输入数字、字母、下划线（_）或横杠（-）的组合！'

export const psd = /^(?=.*[a-z])(?=.*\d)(?:(?=.*[~!@#$%^&*\(\)_+\[\]<>.\-=]))+.{12,24}$/i // 密码：12-24位数字、字母和符号组成

export const email = /^[.\w]+@[\w-]+(.cn|.com|.net|.org|.miit.gov.cn)+$/

export const mphone
  = /^((\\+86)|(\\(\\+86\\)))?(13\d{9}|14\d{9}|15\d{9}|16\d{9}||17\d{9}|18\d{9}|19\d{9})$$/
 ...
 * @param callback
 */
export function validatorIntRange(rule: any, value: any, callback: any) {
  const rules = intRule
  const { max, min } = value || {}
 ...
 * 验证数字范围最多一位小数
 */
export function validatorNumberRange(rule: any, value: any, callback: any) {
 ...
 *  验证数字范围最多两位小数
 */
export function validatorNumberFloat2Range(rule: any, value: any, callback: any) {
 ...
 * @param callback
 */
export function validatorNumberFloat2(rule: any, value: any, callback: any) {
  const rules = numbers02
...
export function validatorNumber(rule: any, value: any, callback: any) {
  const rules = numbers01
  const { msg, required, maxVal } = rule
 ...
 * @param callback
 */
export function validatorInt(rule: any, value: any, callback: any) {
  const rules = intRule
  const { msg, required, maxVal } = rule
 ...
 * @param callback
 */
export function validatorJson(rule: any, value: any, callback: any) {
 ...
 * @param callback
 */
export function validatorWord1(rule: any, value: any, callback: any) {
 ...
 * @param callback
 */
export function validatorWord2(rule: any, value: any, callback: any) {
 ...
 * @param callback
 */
export function validateArray(rule: any, value: any, callback: any) {
  const rules = /^\[((\d+(\.\d+)?|"[^"]*")(, ?)?)*\]$/
  const { msg, required } = rule
 ...
 * @param callback
 */
export function validatorAccount(rule: any, value: any, callback: any) {
  const { msg, required } = rule
