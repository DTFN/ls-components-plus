import { defineComponent, h } from './chunk-AESL644W.js';
import './chunk-SNAQBZPT.js';

// ../../node_modules/.pnpm/@iconify+vue@4.1.2_vue@3.4.38_typescript@5.5.4_/node_modules/@iconify/vue/dist/iconify.mjs
...
function listIcons(provider, prefix) {
  ...
  providers.forEach(provider2 => {
    const prefixes =
      typeof provider2 === 'string' && typeof prefix === 'string' ? [prefix] : Object.keys(dataStorage[provider2] || {});
    prefixes.forEach(prefix2 => {
      const storage2 = getStorage(provider2, prefix2);
      allIcons = allIcons.concat(
        Object.keys(storage2.icons).map(name => (provider2 !== '' ? '@' + provider2 + ':' : '') + prefix2 + ':' + name)
      );
    });
  });
  return allIcons;
