...
import { isMiddleOrRightButtonOnMouseUpDown, stop } from './chunk-RGQRN4HP.js';
import {
...
function findAxisModels(seriesModel) {
  ...
  each(axisModelMap, function (v, key) {
    ...
    if (true) {
      if (!axisModel) {
        throw new Error(
          axisType + ' "' + retrieve3(seriesModel.get(axisType + 'Index'), seriesModel.get(axisType + 'Id'), 0) + '" not found'
        );
      }
    }
...
var Grid =
  ...
  (function () {
    ...
    Grid2.prototype._findConvertTarget = function (finder) {
      ...
      var xAxisModel =
        finder.xAxisModel || (seriesModel && seriesModel.getReferringComponents('xAxis', SINGLE_REFERRING).models[0]);
      var yAxisModel =
        finder.yAxisModel || (seriesModel && seriesModel.getReferringComponents('yAxis', SINGLE_REFERRING).models[0]);
...
var CartesianAxisView =
  ...
  (function (_super) {
    ...
    CartesianAxisView2.prototype.render = function (axisModel, ecModel, api, payload) {
      ...
      var axisBuilder = new AxisBuilder_default(
        axisModel,
        extend(
          {
    ...
    RadarView2.prototype._buildSplitLineAndArea = function (radarModel) {
      ...
      if (shape === 'circle') {
        ...
        var axesTicksPoints = map(indicatorAxes, function (indicatorAxis, idx) {
          ...
          realSplitNumber_1 =
            realSplitNumber_1 == null ? ticksCoords.length - 1 : Math.min(ticksCoords.length - 1, realSplitNumber_1);
...
var SVGParser = (function () {
  ...
  SVGParser2.prototype._parseText = function (xmlNode, parentGroup) {
    ...
    var font =
      ...
      [textStyle.fontStyle, textStyle.fontWeight, (textStyle.fontSize || 12) + 'px', textStyle.fontFamily || 'sans-serif'].join(
        ' '
      );
    textStyle.font = font;
    ...
    GeoCreator2.prototype.create = function (ecModel, api) {
      ...
      each(mapModelGroupBySeries, function (mapSeries, mapType) {
        ...
        geo.zoomLimit = retrieve.apply(
          null,
          map(mapSeries, function (singleMapSeries) {
...
var GeoModel =
  ...
  (function (_super) {
    ...
    GeoModel2.prototype.getFormattedLabel = function (name, status) {
      ...
      var formatter =
        status === 'normal' ? regionModel.get(['label', 'formatter']) : regionModel.get(['emphasis', 'label', 'formatter']);
      var params = {
        name
      };
...
var Parallel =
  ...
  (function () {
      ...
      each2(
        ...
        function (dim, idx) {
          ...
          var axis = this._axesMap.set(
            dim,
            new ParallelAxis_default(dim, createScaleByModel(axisModel), [0, 0], axisModel.get('type'), axisIndex)
          );
          var isCategory = axis.type === 'category';
          axis.onBand = isCategory && axisModel.get('boundaryGap');
          axis.inverse = axisModel.get('inverse');
    ...
    Parallel2.prototype._makeLayoutInfo = function () {
      ...
      var winInnerIndices = [
        mathFloor(round2(axisExpandWindow[0] / axisExpandWidth, 1)) + 1,
        mathCeil(round2(axisExpandWindow[1] / axisExpandWidth, 1)) - 1
      ];
...
var BrushController =
  ...
  (function (_super) {
    ...
    BrushController2.prototype.updateCovers = function (coverConfigList) {
      ...
      new DataDiffer_default(oldCovers, coverConfigList, oldGetKey, getKey)
        .add(addOrUpdate)
        .update(addOrUpdate)
        .remove(remove)
        .execute();
      ...
      function addOrUpdate(newIndex, oldIndex) {
        ...
        if (oldIndex != null && oldCovers[oldIndex] === creatingCover) {
          ...
          var cover = (newCovers[newIndex] =
            oldIndex != null
              ? ((oldCovers[oldIndex].__brushOption = newBrushInternal), oldCovers[oldIndex])
...
var VisualMapping =
  ...
  (function () {
    ...
    VisualMapping2.retrieveVisuals = function (obj) {
      ...
      var hasVisual;
      obj &&
        each3(VisualMapping2.visualHandlers, function (h, visualType) {
...
var TRANSFORM_PROPS_MAP = reduce(
  TRANSFORMABLE_PROPS,
  function (obj, key) {
    obj[key] = 1;
    return obj;
...
function prepareStyleTransitionFrom(fromEl, elOption, styleOpt, transFromProps) {
  ...
  if (fromElStyle) {
    ...
    if (styleTransition && !isTransitionAll(styleTransition)) {
      ...
      (isTransitionAll(elTransition) || isTransitionAll(styleTransition) || indexOf(elTransition, 'style') >= 0)
    ) {
...
//# sourceMappingURL=chunk-5JDQZS2L.js.map
