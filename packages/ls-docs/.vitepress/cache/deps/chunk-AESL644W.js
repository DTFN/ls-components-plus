...
var BaseReactiveHandler = class {
  ...
  get(target, key, receiver) {
    ...
    if (key === '__v_isReactive') {
      ...
      if (
        receiver ===
          (isReadonly2 ? (isShallow2 ? shallowReadonlyMap : readonlyMap) : isShallow2 ? shallowReactiveMap : reactiveMap).get(
            target
...
function trackRefValue(ref2) {
  ...
  if (shouldTrack && activeEffect) {
    ...
    trackEffect(
      ...
      (_a = ref2.dep) != null
        ? _a
        : (ref2.dep = createDep(() => (ref2.dep = void 0), ref2 instanceof ComputedRefImpl ? ref2 : void 0)),
      true
        ? {
            target: ref2,
            type: 'get',
...
function createHydrationFunctions(rendererInternals) {
  const {
    mt: mountComponent,
    p: patch,
    o: { patchProp: patchProp2, createText, nextSibling, parentNode, remove: remove2, insert, createComment }
  } = rendererInternals;
  ...
  try {
    if (vnode.shapeFlag & 4) {
      ...
      result = normalizeVNode(
        render2.call(thisProxy, proxyToUse, renderCache, true ? shallowReadonly(props) : props, setupState, data, ctx)
      );
...
// ../../node_modules/.pnpm/vue@3.4.38_typescript@5.5.4/node_modules/vue/dist/vue.runtime.esm-bundler.js
function initDev() {
  {
    initCustomFormatter();
  }
...
vue/dist/vue.runtime.esm-bundler.js:
  ...
  **)
*/
//# sourceMappingURL=chunk-AESL644W.js.map
