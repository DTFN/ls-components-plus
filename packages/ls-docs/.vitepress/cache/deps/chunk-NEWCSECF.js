...
function prepareSeriesDataSchema(source, opt) {
  ...
  function getResultItem(dimIdx) {
    ...
    if (idx < 0) {
      ...
      var dimDefItem = isObject(dimDefItemRaw)
        ? dimDefItemRaw
        : {
            name: dimDefItemRaw
          };
...
function injectOrdinalMeta(dimInfoList, createInvertedIndices, coordSysInfo) {
  ...
  var hasNameEncode;
  coordSysInfo &&
    each(dimInfoList, function (dimInfo, dimIndex) {
...
export { createDimensions, prepareSeriesDataSchema, createSeriesData_default };
//# sourceMappingURL=chunk-NEWCSECF.js.map
