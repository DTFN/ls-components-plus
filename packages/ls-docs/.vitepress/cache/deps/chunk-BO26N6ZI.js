...
import { brushSingle, init, registerPainter, registerSSRDataGetter, sort } from './chunk-RGQRN4HP.js';
import {
...
function normalizeSetOptionInput(opts) {
  ...
  opts &&
    each(normalizeToArray(opts.replaceMerge), function (mainType) {
      if (true) {
      ...
      for (var j = idxInStack - 1; j >= 0; j--) {
        ...
        if (stackedDataRawIndex >= 0) {
          ...
          if (
            ...
            (stackStrategy === 'samesign' && sum >= 0 && val > 0) ||
            (stackStrategy === 'samesign' && sum <= 0 && val < 0)
          ) {
            sum = addSafe(sum, val);
            stackedOver = val;
...
function defaultLoading(api, opts) {
  ...
  group.resize = function () {
    ...
    var cx =
      (api.getWidth() - r * 2 - (opts.showSpinner && textWidth ? 10 : 0) - textWidth) / 2 -
                  ...
                  if (view && view.containPoint) {
                    ...
                    if (true) {
                      warn(
                        key +
                          ': ' +
                          (view ? 'The found component do not support containPoint.' : 'No view mapping to the found component.')
                      );
                    }
                  }
                } else {
        ...
        function doPrepare(model) {
          ...
          if (!view2) {
            ...
            var Clazz = isComponent
              ? Component_default2.getClass(classType.main, classType.sub)
              : // FIXME:TS
  ...
  if (isClient) {
    ...
    if (true) {
      if (
        ...
        ((!dom.clientWidth && (!opts || opts.width == null)) || (!dom.clientHeight && (!opts || opts.height == null)))
      ) {
        warn(
  ...
  (function () {
    function SeriesData2(dimensionsInput, hostModel) {
      ...
      for (var i = 0; i < dimensions.length; i++) {
        ...
        var dimensionInfo = isString(dimInfoInput)
          ? new SeriesDimensionDefine_default({
              name: dimInfoInput
            })
          : !(dimInfoInput instanceof SeriesDimensionDefine_default)
            ? new SeriesDimensionDefine_default(dimInfoInput)
            : dimInfoInput;
    ...
    SeriesData2.internalField = (function () {
      ...
      cloneListForMapAndSample = function (original) {
        var list = new SeriesData2(
          original._schema ? original._schema : map2(original.dimensions, original._getDimInfo, original),
          original.hostModel
        );
...
var TimeScale =
  ...
  (function (_super) {
    ...
    TimeScale2.prototype.getLabel = function (tick) {
      ...
      return format(
        tick.value,
        fullLeveledFormatter[getDefaultFormatPrecisionOfInterval(getPrimaryTimeUnit(this._minLevelUnit))] ||
...
function getIntervalTicks(bottomUnitName, approxInterval, isUTC, extent) {
  ...
  var levelsTicksInExtent = filter(
    map(levelsTicks, function (levelTicks2) {
...
//# sourceMappingURL=chunk-BO26N6ZI.js.map
