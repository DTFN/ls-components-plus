import { DISPLAY_STATES, Polyline_default, SPECIAL_STATES } from './chunk-NFXVF2BT.js';
import {
  PathProxy_default,
  Path_default,
  Point_default,
...
function updateLabelLinePoints(target, labelLineModel) {
  ...
  for (var i = 0; i < searchSpace.length; i++) {
    ...
    var dist2 = anchorPoint
      ...
      : target instanceof Path_default
...
export { updateLabelLinePoints, limitTurnAngle, limitSurfaceAngle, setLabelLineStyle, getLabelLineStatesModels };
//# sourceMappingURL=chunk-GI2ZEGHQ.js.map
