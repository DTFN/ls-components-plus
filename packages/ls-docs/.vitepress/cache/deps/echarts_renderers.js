...
function getCssString(selectorNodes, animationNodes, opts) {
  ...
  var selectors = map(keys(selectorNodes), function (className) {
    return (
      className +
      bracketBegin +
      map(keys(selectorNodes[className]), function (attrName) {
  ...
  var animations = map(keys(animationNodes), function (animationName) {
    return (
      ...
      animationName +
      bracketBegin +
      map(keys(animationNodes[animationName]), function (percent) {
        return (
          percent +
          bracketBegin +
          map(keys(animationNodes[animationName][percent]), function (attrName) {
...
export { install2 as CanvasRenderer, install as SVGRenderer };
