import { del, isVue2, set } from './chunk-ZCGRYZ5U.js';
...
// ../../node_modules/.pnpm/pinia@2.2.2_typescript@5.5.4_vue@3.4.38_typescript@5.5.4_/node_modules/pinia/dist/pinia.mjs
var activePinia;
...
var isMacOSWebView = (() =>
  /Macintosh/.test(_navigator.userAgent) && /AppleWebKit/.test(_navigator.userAgent) && !/Safari/.test(_navigator.userAgent))();
  ...
  for (const key in setupStore) {
    ...
    if ((isRef(prop) && !isComputed(prop)) || isReactive(prop)) {
      ...
      if (isComputed(prop)) {
        ...
        if (IS_CLIENT) {
          const getters =
            setupStore._getters || // @ts-expect-error: same
...
This will fail in production.`);
    ...
    if (IS_CLIENT) {
      ...
      if (
        currentInstance &&
        currentInstance.proxy && // avoid adding stores that are just built for hot module replacement
        !hot
      ) {
