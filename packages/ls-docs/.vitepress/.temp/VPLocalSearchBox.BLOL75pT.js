...
import {
  ...
  p as pathToFile,
  a as useRouter,
  c as createSearchTranslate,
  i as inBrowser,
  e as escapeRegExp
} from './app.js';
import { _ as _export_sfc } from './plugin-vue_export-helper.1tPrXgE0.js';
import './index.CPga6H0h.js';
import 'dayjs';
import 'element-plus';
import 'vue3-print-nb';
import '@lingshugroup/web-plus/directives';
const localSearchIndex = { root: () => import('./@localSearchIndexroot.f6Cdi5bD.js') };
function toValue(r) {
...
var createFocusTrap = function createFocusTrap2(elements, userOptions) {
    ...
    if (state.tabbableGroups.length > 0) {
      ...
      if (containerIndex < 0) {
        ...
        if (lastOfGroupIndex >= 0) {
          ...
          destinationNode =
            getTabIndex(target) >= 0 ? _destinationGroup.firstTabbableNode : _destinationGroup.firstDomTabbableNode;
        } else if (!isTabEvent(event)) {
  ...
  var mutationObserver =
    typeof window !== 'undefined' && 'MutationObserver' in window ? new MutationObserver(checkDomRemoval) : void 0;
...
class MiniSearch {
  ...
  executeQuerySpec(query, searchOptions) {
    ...
    const boosts = (options.fields || this._options.fields).reduce(
      (boosts2, field) => Object.assign(Object.assign({}, boosts2), { [field]: getOwnProperty(options.boost, field) || 1 }),
      {}
    );
    ...
    for (const field of Object.keys(fieldBoosts)) {
      ...
      for (const docId of fieldTermFreqs.keys()) {
        ...
        const docBoost = boostDocumentFn
          ? boostDocumentFn(this._documentIds.get(docId), derivedTerm, this._storedFields.get(docId))
          : 1;
...
const objectToNumericMapAsync = object =>
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const searchIndex = computedAsync(async () => {
      ...
      return markRaw(
        MiniSearch.loadJSON(
          (_c = await ((_b2 = (_a2 = searchIndexData.value)[localeIndex.value]) == null ? void 0 : _b2.call(_a2))) == null
            ? void 0
            : _c.default,
          {
            ...
            searchOptions: {
              ...
              ...(((_d = theme.value.search) == null ? void 0 : _d.provider) === 'local' &&
                ((_f = (_e = theme.value.search.options) == null ? void 0 : _e.miniSearch) == null ? void 0 : _f.searchOptions))
            },
            ...(((_g = theme.value.search) == null ? void 0 : _g.provider) === 'local' &&
              ((_i = (_h = theme.value.search.options) == null ? void 0 : _h.miniSearch) == null ? void 0 : _i.options))
          }
        )
      );
    });
    const disableQueryPersistence = computed(() => {
      var _a2, _b2;
      return (
        ((_a2 = theme.value.search) == null ? void 0 : _a2.provider) === 'local' &&
        ((_b2 = theme.value.search.options) == null ? void 0 : _b2.disableQueryPersistence) === true
      );
    });
    ...
    const showDetailedList = useLocalStorage(
      ...
      ((_a = theme.value.search) == null ? void 0 : _a.provider) === 'local' &&
        ((_b = theme.value.search.options) == null ? void 0 : _b.detailedView) === true
    );
    const disableDetailedView = computed(() => {
      var _a2, _b2, _c;
      return (
        ((_a2 = theme.value.search) == null ? void 0 : _a2.provider) === 'local' &&
        (((_b2 = theme.value.search.options) == null ? void 0 : _b2.disableDetailedView) === true ||
          ((_c = theme.value.search.options) == null ? void 0 : _c.detailedView) === false)
      );
    });
    const buttonText = computed(() => {
      ...
      return (
        ((_e =
          (_d =
            (_c = (_b2 = options == null ? void 0 : options.locales) == null ? void 0 : _b2[localeIndex.value]) == null
              ? void 0
          ...
          ? void 0
          : _e.buttonText) ||
        ((_g = (_f = options == null ? void 0 : options.translations) == null ? void 0 : _f.button) == null
          ? void 0
          : _g.buttonText) ||
        'Search'
      );
    ...
    debouncedWatch(
      ...
      async ([index, filterTextValue, showDetailedListValue], old, onCleanup) => {
        ...
        (_d = (_c = resultsEl.value) == null ? void 0 : _c.firstElementChild) == null
          ? void 0
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(
        ...
        _push2 => {
          ...
          _push2(
            `<div role="button"${ssrRenderAttr('aria-owns', ((_a2 = results.value) == null ? void 0 : _a2.length) ? 'localsearch-list' : void 0)} aria-expanded="true" aria-haspopup="listbox" aria-labelledby="localsearch-label" class="VPLocalSearchBox" data-v-cc153ccb><div class="backdrop" data-v-cc153ccb></div><div class="shell" data-v-cc153ccb><form class="search-bar" data-v-cc153ccb><label${ssrRenderAttr('title', buttonText.value)} id="localsearch-label" for="localsearch-input" data-v-cc153ccb><span aria-hidden="true" class="vpi-search search-icon local-search-icon" data-v-cc153ccb></span></label><div class="search-actions before" data-v-cc153ccb><button class="back-button"${ssrRenderAttr('title', unref(translate)('modal.backButtonTitle'))} data-v-cc153ccb><span class="vpi-arrow-left local-search-icon" data-v-cc153ccb></span></button></div><input${ssrRenderAttr('value', unref(filterText))}${ssrRenderAttr('aria-activedescendant', selectedIndex.value > -1 ? 'localsearch-item-' + selectedIndex.value : void 0)} aria-autocomplete="both"${ssrRenderAttr('aria-controls', ((_b2 = results.value) == null ? void 0 : _b2.length) ? 'localsearch-list' : void 0)} aria-labelledby="localsearch-label" autocapitalize="off" autocomplete="off" autocorrect="off" class="search-input" id="localsearch-input" enterkeyhint="go" maxlength="64"${ssrRenderAttr('placeholder', buttonText.value)} spellcheck="false" type="search" data-v-cc153ccb><div class="search-actions" data-v-cc153ccb>`
          );
          if (!disableDetailedView.value) {
            _push2(
              `<button type="button" class="${ssrRenderClass([{ 'detailed-list': unref(showDetailedList) }, 'toggle-layout-button'])}"${ssrRenderAttr('title', unref(translate)('modal.displayDetails'))} data-v-cc153ccb><span class="vpi-layout-list local-search-icon" data-v-cc153ccb></span></button>`
            );
          } else {
            _push2(`<!---->`);
          }
          _push2(
            `<button class="clear-button" type="reset"${ssrIncludeBooleanAttr(disableReset.value) ? ' disabled' : ''}${ssrRenderAttr('title', unref(translate)('modal.resetButtonTitle'))} data-v-cc153ccb><span class="vpi-delete local-search-icon" data-v-cc153ccb></span></button></div></form><ul${ssrRenderAttr('id', ((_c = results.value) == null ? void 0 : _c.length) ? 'localsearch-list' : void 0)}${ssrRenderAttr('role', ((_d = results.value) == null ? void 0 : _d.length) ? 'listbox' : void 0)}${ssrRenderAttr('aria-labelledby', ((_e = results.value) == null ? void 0 : _e.length) ? 'localsearch-label' : void 0)} class="results" data-v-cc153ccb><!--[-->`
          );
          ssrRenderList(results.value, (p, index) => {
            _push2(
              `<li${ssrRenderAttr('id', 'localsearch-item-' + index)}${ssrRenderAttr('aria-selected', selectedIndex.value === index ? 'true' : 'false')} role="option" data-v-cc153ccb><a${ssrRenderAttr('href', p.id)} class="${ssrRenderClass(
                [
                  {
              ...
              )}"${ssrRenderAttr('aria-label', [...p.titles, p.title].join(' > '))} data-v-cc153ccb><div data-v-cc153ccb><div class="titles" data-v-cc153ccb><span class="title-icon" data-v-cc153ccb>#</span><!--[-->`
            );
            ssrRenderList(p.titles, (t, index2) => {
              _push2(
                `<span class="title" data-v-cc153ccb><span class="text" data-v-cc153ccb>${t ?? ''}</span><span class="vpi-chevron-right local-search-icon" data-v-cc153ccb></span></span>`
              );
            });
            _push2(
              `<!--]--><span class="title main" data-v-cc153ccb><span class="text" data-v-cc153ccb>${p.title ?? ''}</span></span></div>`
            );
            if (unref(showDetailedList)) {
              _push2(`<div class="excerpt-wrapper" data-v-cc153ccb>`);
              if (p.text) {
                _push2(
                  `<div class="excerpt" inert data-v-cc153ccb><div class="vp-doc" data-v-cc153ccb>${p.text ?? ''}</div></div>`
                );
              } else {
                _push2(`<!---->`);
              }
              _push2(
                `<div class="excerpt-gradient-bottom" data-v-cc153ccb></div><div class="excerpt-gradient-top" data-v-cc153ccb></div></div>`
              );
            } else {
              _push2(`<!---->`);
            }
          ...
          if (unref(filterText) && !results.value.length && enableNoResults.value) {
            _push2(
              `<li class="no-results" data-v-cc153ccb>${ssrInterpolate(unref(translate)('modal.noResultsText'))} &quot;<strong data-v-cc153ccb>${ssrInterpolate(unref(filterText))}</strong>&quot; </li>`
            );
          } else {
            _push2(`<!---->`);
          }
          _push2(
            `</ul><div class="search-keyboard-shortcuts" data-v-cc153ccb><span data-v-cc153ccb><kbd${ssrRenderAttr('aria-label', unref(translate)('modal.footer.navigateUpKeyAriaLabel'))} data-v-cc153ccb><span class="vpi-arrow-up navigate-icon" data-v-cc153ccb></span></kbd><kbd${ssrRenderAttr('aria-label', unref(translate)('modal.footer.navigateDownKeyAriaLabel'))} data-v-cc153ccb><span class="vpi-arrow-down navigate-icon" data-v-cc153ccb></span></kbd> ${ssrInterpolate(unref(translate)('modal.footer.navigateText'))}</span><span data-v-cc153ccb><kbd${ssrRenderAttr('aria-label', unref(translate)('modal.footer.selectKeyAriaLabel'))} data-v-cc153ccb><span class="vpi-corner-down-left navigate-icon" data-v-cc153ccb></span></kbd> ${ssrInterpolate(unref(translate)('modal.footer.selectText'))}</span><span data-v-cc153ccb><kbd${ssrRenderAttr('aria-label', unref(translate)('modal.footer.closeKeyAriaLabel'))} data-v-cc153ccb>esc</kbd> ${ssrInterpolate(unref(translate)('modal.footer.closeText'))}</span></div></div></div>`
          );
        },
        'body',
        false,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    '../../node_modules/.pnpm/vitepress@1.4.1_@algolia+client-search@4.24.0_@types+node@22.5.1_@types+react@18.3.5_async-va_faomye55yxzhkll3p2xlkv5z2q/node_modules/vitepress/dist/client/theme-default/components/VPLocalSearchBox.vue'
  );
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const VPLocalSearchBox = /* @__PURE__ */ _export_sfc(_sfc_main, [['__scopeId', 'data-v-cc153ccb']]);
