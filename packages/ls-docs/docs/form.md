...
>
  ...
  -->
  <template #title="{ slotRow }">
    <div style="width:100%;padding:8px 0 4px;font-size:14px;font-weight:600;color:#303133;border-bottom:2px solid #409EFF">
      <span style="display:inline-block;width:3px;height:14px;background:#409EFF;border-radius:2px;vertical-align:middle;margin-right:6px"></span>
      {{ slotRow.label }}
    </div>
  </template>
</LSForm>
